...
\newcommand{\varTitle}{Characterization of the Intrinsic EMC-relevant Emissions of Power Semiconductor Devices}
...
\documentclass[%				
	...
	% parskip=never,%			%% Definition von Absatzeinzug bzw. Absatzabstand
...
\pgfkeys{/pgf/number format/.cd ,set thousands separator={}} %Globale einstellungen für Grafiken mit tikz/pgf.
