...
\begin{figure}[h]
	\centering
	\import{./figures/}{"B2B_Setup_pic.pdf_tex"}
	\caption{Photograph of measurement setup. (Change to new picture including two probes and the active shunt)}
	\label{fig:pic_b2b_setup}
\end{figure}
