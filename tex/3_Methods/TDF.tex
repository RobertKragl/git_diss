...
\section{Time-Dependent Noise Filter}
...
% 		\centering
% 		\input{"Methods/SnapNMirror/DPT_TD.tex"}
% 		\caption{Time domain simulation of double pulse test.}
% 	\end{subfigure} %
% 	\hfill
% 	\begin{subfigure}{0.48\textwidth}
% 		\centering
% 		\input{"Methods/SnapNMirror/DPT_FD.tex"}
% 		\caption{Frequency spectrum of simulated double pulse test.}
% 	\end{subfigure} %
% 	\begin{subfigure}{0.48\textwidth}
% 		\centering
% 		\input{"Methods/SnapNMirror/Snapped_TD.tex"}
% 		\caption{Separation into four artificial signals containing frequency components of one switching event only.}
% 	\end{subfigure}
% 	\hfill
% 	\begin{subfigure}{0.48\textwidth}
% 		\centering
% 		\input{"Methods/SnapNMirror/Snapped_FD.tex"}
